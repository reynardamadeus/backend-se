<div class="form_popup bg-gradient-to-b from-[#72C5E0] via-white to-[#72C5E0]" id="SelectionSMA">
    ...
    <div class="bg-white/50 backdrop-blur-lg p-8 rounded-xl shadow-lg w-96 text-center">
        ...
        <div class="space-y-4">
            <form action="{{route('exercise.material.filter')}}" method="post"  onsubmit="return closeClassSelectionSMA()">
                @csrf
                ...
                <label class="block mb-4">
                    <input type="radio" name="kelas" value="SMA - Kelas 3" class="custom-radio w-full py-3 bg-white text-black font-bold rounded-xl

<div class="form_popup" id="login_popup"> <!-- login -->
    <form class="login-container" action="{{route('login')}}" method="POST">
        ...
        <a href="{{route('forgotpassword.request.get')}}" class="forgot-password">Forgot Password?</a>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        @if ($errors->any() || session('show_login_popup') || session('success') || session('login_error'))
            openLogin();
        @endif

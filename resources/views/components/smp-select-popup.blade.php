    ...
    <div class="bg-white/50 backdrop-blur-lg p-8 rounded-xl shadow-lg w-96 text-center">
        ...
        <div class="space-y-4">
            <label class="block mb-4">
                ...
                shadow-md hover:bg-gray-200" onclick="selectLevel('SMP - Kelas 1')">
            ...
            <label class="block mb-4">
                ...
                shadow-md hover:bg-gray-200" onclick="selectLevel('SMP - Kelas 2')">
                <span class="custom-label">Kelas 2</span>
            </label>
            <label class="block mb-4">
                <input type="radio" name="kelas" value="SMP - Kelas 1" class="custom-radio w-full py-3 bg-white text-black font-bold rounded-xl 
                shadow-md hover:bg-gray-200" onclick="selectLevel('SMP - Kelas 3')">
        ...
        <div class="flex justify-between mt-6">
            ...
            <button class="w-24 py-3 bg-gray-800 text-white font-bold rounded-xl shadow-md hover:bg-gray-900"
                onclick="closeClassSelectionSMP()">Save</button>
        </div>
    </div>
</div>

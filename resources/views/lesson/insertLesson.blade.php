    ...
    <x-header />
        <div class="bg-gray-100 p-8">
            <div class="w-full mx-auto bg-white p-6 shadow-md rounded-lg">
                <h1 class="text-xl font-bold mb-4">Insert Material Content</h1>
                <!-- Start of Form -->
                <form id="editor-form" method="POST" action="{{ route('lesson.content.create', $id) }}" onsubmit="return submitQuillContent();">
                    @csrf
